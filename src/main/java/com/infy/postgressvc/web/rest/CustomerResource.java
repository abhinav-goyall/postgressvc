...
import com.infy.postgressvc.web.rest.errors.BadRequestAlertException;
import com.infy.postgressvc.web.rest.util.HeaderUtil;
...
public String ping() {
    ...
    private static final String ENTITY_NAME = "postgressvcCustomer";
