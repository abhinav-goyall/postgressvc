package com.infy.postgressvc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("postgressvc");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("postgressvc");
        ...
        config.getMapConfigs().put("com.infy.postgressvc.domain.*", initializeDomainMapConfig(jHipsterProperties));
